...
begin
  with v
  do begin
    Word(height) := GetDlgItemInt( hWindow, 100, translated, false );
    Word(width) := GetDlgItemInt( hWindow, 101, translated, false );
    Word(txtH) := GetDlgItemInt( hWindow, 102, translated, false );
    inc(height, txtH);
