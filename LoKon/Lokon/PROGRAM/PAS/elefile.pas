...
type
  ...
  tLay = object
    ...
    function GetID(Element : Pointer) : tPoint;
...
function tLay.GetID(Element : Pointer) : tPoint;
{ Ermittelt Position des Elements in EleFiles:
    X  -  Position in EleWin (Lo)
    Y  -  Position von EleWin in EleFiles. (Hi) }
var
  A : tPoint;
